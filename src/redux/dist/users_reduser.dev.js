...
var initialState = {
  users: [{
    ...
    followed: true,
    fullName: 'Andrew',
    status: 'Be kind, for everyone you meet is fighting a harder battle.',
    location: {
      country: 'Belgium',
      city: 'Brussels'
    }
    ...
    followed: true,
    fullName: 'Boris',
    status: 'Every heart sings a song, incomplete, until another heart whispers back.',
    location: {
      country: 'Germany',
      city: 'Berlin'
    }
    ...
    followed: false,
    fullName: 'Donald',
    status: 'Wise men speak because they have something to say; fools because they have to say something.',
    location: {
      country: 'Italy',
      city: 'Milan'
    }
